...
//        fadeTransition.play();
        ...
        gridPane.getStylesheets().addAll(getClass().getResource("style.css").toExternalForm());
        TranslateTransition translateTransition=new TranslateTransition(Duration.seconds(0.5),drawerPane);
        translateTransition.setByX(-300);
        translateTransition.play();

        pane1.setStyle("-fx-background-image: url('sample/bmw1.jpg')");
        pane2.setStyle("-fx-background-image: url('sample/bmw2.jpg')");
        pane3.setStyle("-fx-background-image: url('sample/bmw3.jpg')");
        pane4.setStyle("-fx-background-image: url('sample/bmw4.jpg')");
